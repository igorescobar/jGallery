...
(function ($) {
  ...
  $.fn.setjGalleryEvents = function () {
    ...
    $('.jgContainer .image div.nav a.next').bind('click', function () {
      ...
      if (jgOptions.openedImage.next().length > 0) {
        $(this).switchImage(jgOptions.openedImage.next('a'));
      }
    ...
    $('.jgContainer .image div.nav a.prev').bind('click', function () {
      ...
      if (jgOptions.openedImage.prev().length > 0) {
        $(this).switchImage(jgOptions.openedImage.prev('a'));
      }
    ...
    $('.jgContainer .image .subNav a.jgcarocel-prev').bind('click', function () {
      ...
      var container_width = parseInt(jgOptions.jgCarrocelGallery.css('width').replace('px', ''), 10),
        atual_container_right = parseInt(jgOptions.jgGallery.css('right').replace('px', ''), 10);
  ...
  $.fn.extend({
    ...
    getProportionalSize: function (width, height) {
    ...
    preLoadImage: function (src, onLoadCallback) {
    ...
    // was clicked
    switchImage: function (oLinkClick) {
      ...
      $(this).preLoadImage(oLinkClick.attr('href'), function (preload) {
        ...
        var sizes = $(this).getProportionalSize(preload.width, preload.height);
        ...
        jgOptions.jgContainerImage.fadeOut('fast', function () {
          ...
          $(this).setImage(oLinkClick.attr('href'), preload.width, preload.height);

          // subtitle attachmend
          if (image_title !== '') {
            $('.jgContainer .image div.legenda').html(image_title);
            $('.jgContainer .image div.legenda').fadeIn('slow');
          } else if (jgOptions.jgCarrocelGallery.css('bottom') === '30px') {
      ...
      $(this).each(function () {
        ...
        $(this).find('a:has(img)').bind('click', function () {
          ...
          jgOptions.openedGallery.find('a:has(img)').each(function () {
            ...
            $(this).getJGalleryTotalWidth();
          });

          // link object
          jgOptions.openedImage = $(this);

          $(this).preLoadImage(jgOptions.openedImage.attr('href'), function () {
            ...
            jgOptions.jgBackground.fadeIn('slow', function () {
              ...
              $(this).switchImage(jgOptions.openedImage);
            });
          });
